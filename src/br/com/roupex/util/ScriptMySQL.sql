...
/*FOREIGN KEY*/
ALTER TABLE 'roupex'.'clientes' ADD CONSTRAINT 'FK_USU_ID' FOREIGN KEY ('usu_id')
REFERENCES 'roupex'.'usuarios'('usu_id');

ALTER TABLE 'roupex'.'enderecos' ADD CONSTRAINT 'FK_CLI_ID' FOREIGN KEY ('cli_id')
REFERENCES 'roupex'.'clientes'('cli_id');

ALTER TABLE 'roupex'.'cartoes' ADD CONSTRAINT 'FK_CLI_ID' FOREIGN KEY ('cli_id')
REFERENCES 'roupex'.'clientes'('cli_id');
